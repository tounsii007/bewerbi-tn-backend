...
@Table(name = "jobs", indexes = {
        ...
        @Index(name = "idx_jobs_category_type", columnList = "category, type")
})
public class Job extends BaseEntity {
    ...
    @Column(name = "employer_user_id", nullable = false, columnDefinition = "uuid")
    ...
    @Column(name = "salary_currency", length = 4)
    ...
    public void setPremium(boolean v) { this.premium = v; }
}
